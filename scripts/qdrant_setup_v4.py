#!/usr/bin/env python3
"""
Qdrant Setup Script for OpenClaw Skill Evolution v4
Creates the required collections with proper schema including new v4 collections
"""
...
def main():
    ...
    # Collection definitions (including v4 new collections)
    collections = [
        ...
        ("policies", "schemas/collections/policies.json"),
        ("failures", "schemas/collections/failures.json"),
        ("collaborations", "schemas/collections/collaborations.json"),
        ("handoffs", "schemas/collections/handoffs.json")
    ]
...
if __name__ == "__main__":
    success = main()
    if success:
        print("🎉 Qdrant v4 setup completed successfully!")
        sys.exit(0)
    else:
        print("💥 Qdrant v4 setup failed!")
        sys.exit(1)